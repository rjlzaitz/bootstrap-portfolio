...
<body>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<a class="brand zaitz" href="index.php"><img src="img/zcloud-icon.png" alt="zcloud-icon" width="26" height="25"></a>
		<div class="navbar-inner">
			...
			<div class="nav-collapse collapse">
				<ul class="nav">
					<li><a id="nav-work" class="nav-link" href="#work" >work</a></li>
					<li><a id="nav-about" class="nav-link" href="#about">about</a></li>
				</ul><!-- .nav -->
